                                             ...
                                             <div class="col-md-6">
                                                  <form action="" method="GET">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <input type="text" name="daterange" autocomplete="off" class="form-control w-50" value="" placeholder="{{ ( isset($_GET["daterange"]) ? $_GET["daterange"] : "" )}}" />
                                                            {{-- {{($_GET["daterange"])}} --}}
                                                            {{-- {{ ( isset($_GET["daterange"]) ? $_GET["daterange"] : "" )}} --}}

                                                       </div>
                                                       <div class="form-group">
                                                            <label>วันที่นัดส่ง</label>
                                                            <input type="text" name="daterange2" autocomplete="off" class="form-control w-50" value="" placeholder="{{ ( isset($_GET["daterange2"]) ? $_GET["daterange2"] : "" )}}" />
