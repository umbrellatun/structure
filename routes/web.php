...
Route::post('/godsplit/search', 'GodSplitController@indexindex')->name('godsplit.search');
...
Route::post('/customer/maintenance', 'HomeController@maintenance')->name('customer.maintenance');
